  ...
  */
  ...
  describe("constructor", () => {
    it('1 - Deploying contract properly...', async () => {
      await Contract.deployed(name, cut, studentGSNDeposit, compoundAddress, relayHubAddress, classroomFactoryAddress, studentFactoryAddress, studentApplicationFactoryAddress, daiAddress);
